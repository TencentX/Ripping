...
public class EventMgr : Singleton<EventMgr>
{
	...
	private Dictionary<string, MapNode > eventMap = new Dictionary<string, MapNode>();
    private Dictionary<object, ObjEventMapNode> objEventMap = new Dictionary<object, ObjEventMapNode>();
	...
	private void AddListenerInternal(string ge, Delegate ef, bool removeOnLoadScene, EventPriority priority)
	{
		...
		{
			//CoreEntry.logMgr.Log(LogLevel.WARNING, "EventMgr", "EventName Error");
			return;
		}
...
//            {
//                LuaMgr.instance.TriggerEvent().Action<string>(ge);
//            }
        }
...
//            if (LuaMgr.instance.TriggerEvent() != null)
//            {
//                LuaMgr.instance.TriggerEvent().Action<string, U>(ge, arg1);
//            }
        }
        catch (System.Exception ex)
        {
...
//            if (LuaMgr.instance.TriggerEvent() != null)
//            {
//                LuaMgr.instance.TriggerEvent().Action<string, U, V>(ge, arg1, arg2);
//            }
        }
        catch (System.Exception ex)
        {
